...
@st.cache_data
def load_data():
    hour_df = pd.read_csv('C:\\Users\\smart user\\Videos\\dashboard\\Bike-sharing-dataset\\hour.csv')
    day_df = pd.read_csv('C:\\Users\\smart user\\Videos\\dashboard\\Bike-sharing-dataset\\day.csv')
